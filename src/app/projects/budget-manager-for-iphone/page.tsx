...
const budgetManager = () => {
  ...
  return (
    <div className="flex flex-col w-[70%] mx-auto mt-20 lg:mt-0">
      ...
      <div className="relative myFont text-9xl flex justify-center items-center py-2 mb-10">
        ...
        <div className="text-center text-(--beigeCustom) text-7xl">
          BUDGET MANAGER
        </div>
      </div>
      ...
      <ScrollFader animationDurationDirection="Down">
        <div className="flex flex-row justify-center gap-4 flex-wrap mt-10">
